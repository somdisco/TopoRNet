...
inline arma::umat geodesicdist(const arma::umat& ADJ, bool weighted = false, bool directed = false) {
  ...
  Rcpp::NumericMatrix SPDISTRCPP = igfxn_distances(Rcpp::Named("graph", ig)); 
...
inline Rcpp::NumericMatrix geodesicdist_numeric(const arma::umat& ADJ, bool weighted = false, bool directed = false) {
  // Calculate the geodesic distances between vertices, given an adjacency matrix 
  ...
  return SPDISTRCPP; 
  // Convert to umat and return 
  //return Rcpp::as<arma::umat>(SPDISTRCPP); 
}
